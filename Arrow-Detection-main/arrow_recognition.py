...
def main():
    log_initialization()
    right_arrow = cv2.imread("Arrow-Detection-main\Arrow-Detection-main\Right_Arrow.png", cv2.IMREAD_GRAYSCALE)
    left_arrow = cv2.imread("Arrow-Detection-main\Arrow-Detection-main\Left_arrow.png", cv2.IMREAD_GRAYSCALE)
